...
command="sudo ip netns exec "+str(tenantNO)+"-north echo "nameserver 8.8.8.8" > /etc/resolv.conf"
os.system(command)
command="sudo ip netns exec "+str(tenantNO)+"-south echo "nameserver 8.8.8.8" > /etc/resolv.conf"
os.system(command)
...
natrule5="sudo iptables -t nat -A POSTROUTING  -o eth1 ! -d 10."+str(tenantNO)+".0.0/24  -s 10."+str(tenantNO)+".0.0/24 -j MASQUERADE "
os.system(natrule1)
os.system(natrule2)
os.system(natrule3)
os.system(natrule4)
